...
class fanfiction_pagelinks_ui extends e_admin_ui
{
	...
	//	protected $listQry      	= "SELECT * FROM `#tableName` WHERE field != '' "; // Example Custom Query. LEFT JOINS allowed. Should be without any Order or Limit.
		...
		protected $fields 		= array (
			...
			'link_name'               => array ( 'title' => LAN_NAME, 'type' => 'text', 
			'data' => 'safestr', 'width' => 'auto', 'filter' => true, 
			'inline' => true,   'help' => '', 
			'readParms' => [], 'writeParms' => [], 'class' => 'left', 'thclass' => 'left',),
			'link_text'               => array ( 'title' => 'Text', 'type' => 'text', 
			'data' => 'safestr', 'width' => 'auto', 'inline' => true, 'help' => '', 'readParms' => [], 
			'writeParms' => ['size'=>'xlarge'], 'class' => 'left', 'thclass' => 'left',),
			'link_url'                => array ( 'title' => LAN_URL, 'type' => 'url', 'data' => 'safestr', 'width' => 'auto', 'inline' => true, 'help' => '', 'readParms' => [], 'writeParms' => [], 'class' => 'left', 'thclass' => 'left',),
	...
	//	protected $preftabs        = array('General', 'Other' );
		...
		'linkstyle'		=> array('title'=> LAN_LINKRANGE, 'tab'=>0, 'type'=>'dropdown', 'data' => 'str', 
			'help'=> LAN_HELP_LINKSTYLE, 
			'writeParms' => ['optArray' => array(2 => LAN_BOTHLINKSTYLE, 1 => LAN_FIRSTLAST, 0 => LAN_NEXTPREV)]),

		'linkrange'		=> array('title' => LAN_LINKSTYLE, 'tab' => 0, 'type' => 'number', 
		'data' => 'int', 'help' => LAN_HELP_LINKRANGE, 'writeParms' => ['default'=>5]),
