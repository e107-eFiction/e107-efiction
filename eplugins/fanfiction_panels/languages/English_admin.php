...
define("LAN_VISIBLE", "Visible");
define("LAN_HIDDEN", "Hidden");
...
// define ("_ARCHIVEMAINT", "Archive Maintentance");
// define ("_AUTHORRELEASED", "The author has been removed from the admin created list, and an e-mail has been sent to them with their temporary password. <br /><br /><a href=\"admin_main.php?action=members\">Back to Members Maintenance</a>");
