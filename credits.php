...
if (!defined('e107_INIT'))
{
	...
	$css = "body 				{ background: rgb(55, 55, 55); padding:50px; color: white; text-align: left; font-size:16px; line-height:1.5em; font-weight:normal; font-family:Arial, Helvetica, sans-serif; }
			...
			.wrapper			{ width:90%;  margin:0px auto 0px 0px; margin-left: auto; margin-right: auto; padding-bottom:10px;  }
 ...
 $text ='<div class="wrapper row">
        	<div class="wrapper-middle w-50">
...
$text .= ' 
        	<div class="wrapper-middle w-50">
                <div class="well credits-content">
                	<img class="logo" src="' . e_IMAGE_ABS . 'admin_images/credits_efiction.png" alt="e107 Logo" title="e107  bootstrap content management system logo" />
                	<div class="wrapper-text">

					    <h4 class="text-info">eFiction 6</h4>
	                    <p>
							Humbly trying to pick up from where you left - because nobody else did.
	                    </p>

					    <h4 class="text-info">eFiction 5</h4>
	                    <p>
	                        Copyright (c) 2015-2021 by Rainer Volkrodt
	                    </p>

	                    <h4 class="text-info">eFiction 3</h4>
	                    <p>
	                        Copyright (c) 2007 by Tammy Keefer 
	                    </p>


	                    <h4 class="text-info">eFiction 1.1</h4>
	                    <p>
	                        Original Developer: Rebecca Smallwood (Rivka)
	                    </p>

						 <h4 class="text-info">Sponsors</h4>
	                    <p>
	                        <a target="_blank" href="https://hpkizi.sk" title="hpkizi.sk o.z.">hpkizi.sk o.z.(Civic Association)</a>, 
							<a target="_blank" href="https://www.jmsupport.sk" title="JM Support s.r.o.">JM Support s.r.o</a><br />
	                    </p>
